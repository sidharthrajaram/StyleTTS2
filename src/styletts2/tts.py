...
class StyleTTS2:
    ...
    def load_model(self, model_path=None, config_path=None, folder=None):
        ...
        # load nltk data
        if folder:
            nltk.data.path.append(f"{folder}/")
    ...
    def long_inference(
        ...
        for text_segment in text_segments:
            ...
            segment_output, prev_s = self.long_inference_segment(
                text_segment, prev_s, ref_s, alpha=alpha, beta=beta, t=t, diffusion_steps=diffusion_steps, embedding_scale=embedding_scale
            )
    ...
    def long_inference_segment(self, text, prev_s, ref_s, alpha=0.3, beta=0.7, t=0.7, diffusion_steps=5, embedding_scale=1):
        """
